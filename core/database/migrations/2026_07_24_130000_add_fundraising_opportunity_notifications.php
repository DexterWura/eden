...
return new class extends Migration
{
    ...
    {
        if (
            Schema::hasTable('startup_funding_rounds')
            && ! Schema::hasColumn('startup_funding_rounds', 'opportunity_announced_at')
        ) {
        ...
        if (! Schema::hasTable('fundraising_opportunity_deliveries')) {
