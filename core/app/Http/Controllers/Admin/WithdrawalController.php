...
class WithdrawalController extends Controller
{
    ...
    public function approve(Request $request)
    {
        ...
        admin_audit_log('withdrawal.approved', "Withdrawal approved: {$withdraw->trx} - " . ($withdraw->user ? $withdraw->user->username : 'N/A') . " - " . $withdraw->amount, $withdraw);
    ...
    public function reject(Request $request)
    {
        ...
        admin_audit_log('withdrawal.rejected', "Withdrawal rejected: {$withdraw->trx} - " . ($withdraw->user ? $withdraw->user->username : 'N/A') . ". Details: " . ($request->details ?? ''), $withdraw, [], ['details' => $request->details ?? '']);
