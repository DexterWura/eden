...
class DepositController extends Controller
{
    ...
    public function approve($id)
    {
        ...
        admin_audit_log('deposit.approved', "Deposit approved: {$deposit->trx} - " . ($deposit->user ? $deposit->user->username : 'N/A') . " - " . $deposit->amount, $deposit);
    ...
    public function reject(Request $request)
    {
        ...
        admin_audit_log('deposit.rejected', "Deposit rejected: {$deposit->trx}. Message: {$request->message}", $deposit, [], ['message' => $request->message]);
