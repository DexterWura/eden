...
<div class="modal fade" id="bugModal" tabindex="-1" role="dialog" aria-labelledby="bugModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="{{ route('admin.request.report.submit') }}" method="post" class="disableSubmission">
        @csrf
...
@push('breadcrumb-plugins')
    ...
    @php
        // WhatsApp number (Zimbabwe format: +263787689820)
        $whatsappNumber = '263787689820';
        $whatsappUrl = "https://wa.me/{$whatsappNumber}";
    @endphp
    <a href="{{ $whatsappUrl }}" target="_blank" class="btn btn-sm btn-outline--success">
        <i class="lab la-whatsapp"></i> @lang('Request Support via WhatsApp')
    </a>
@endpush
