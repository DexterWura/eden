                    ...
                    <div class="card-body">
                        ...
                        <div class="row mt-4 d-none configForm" id="smtp">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="@lang('Normally your email') address" name="username" value="{{ maskForDemo(gs('mail_config')->username ?? '') }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>@lang('Password') </label>
                                    <input type="text" class="form-control" placeholder="@lang('Normally your email password')" name="password" value="{{ maskForDemo(gs('mail_config')->password ?? '') }}">
                                </div>
                            </div>
                        </div>
                        <div class="row mt-4 d-none configForm" id="sendgrid">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" class="form-control" placeholder="@lang('SendGrid App key')" name="appkey" value="{{ maskForDemo(gs('mail_config')->appkey ?? '') }}">
                            </div>
                        </div>
                        <div class="row mt-4 d-none configForm" id="mailjet">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="@lang('Mailjet Api Public Key')" name="public_key" value="{{ maskForDemo(gs('mail_config')->public_key ?? '') }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>@lang('Api Secret Key') </label>
                                    <input type="text" class="form-control" placeholder="@lang('Mailjet Api Secret Key')" name="secret_key" value="{{ maskForDemo(gs('mail_config')->secret_key ?? '') }}">
                                </div>
                            </div>
                        </div>
