                            ...
                            <tbody>
                                @foreach (gs('socialite_credentials') as $key => $credential)
                                    <tr>
                                        ...
                                        <td>{{ maskForDemo($credential->client_id ?? '') }}</td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button class="btn btn-outline--primary btn-sm editBtn"
                                                    data-client_id="{{ maskForDemo($credential->client_id ?? '') }}"
                                                    data-client_secret="{{ maskForDemo($credential->client_secret ?? '') }}"
    ...
    <script>
        (function($) {
            ...
            $(document).on('click', '.editBtn', function() {
                ...
                modal.find('[name=client_id]').val('{{ maskForDemo("") }}' || data.client_id);
                modal.find('[name=client_secret]').val('{{ maskForDemo("") }}' || data.client_secret);
