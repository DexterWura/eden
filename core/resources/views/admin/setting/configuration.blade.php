            ...
            <form method="post">
                ...
                <div class="card-body">
                    <ul class="list-group">
                        ...
                        <li class="list-group-item d-flex flex-wrap flex-sm-nowrap gap-2 justify-content-between align-items-center">
                            <div>
                                <p class="fw-bold mb-0">@lang('Welcome Email')</p>
                                <p class="mb-0">
                                    <small>@lang('When enabled, new users receive a welcome email after signup. When disabled, they do not.') <span class="fw-bold"><i>@lang('Note'):</i></span> <i>@lang('Requires') <span class="fw-bold">@lang('Email Notification')</span> @lang('to be enabled.')</i></small>
                                </p>
                            </div>
                            <div class="form-group">
                                <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-height="35" data-on="@lang('Enable')" data-off="@lang('Disable')" name="welcome_email_enable" @if(gs('welcome_email_enable')) checked @endif>
                            </div>
                        </li>
                        <li class="list-group-item d-flex flex-wrap flex-sm-nowrap gap-2 justify-content-between align-items-center">
                            <div>
