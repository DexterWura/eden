...
<div class="wrap content-block">
  ...
  <p>You may use the site to browse startups, submit your own startup (if you are a founder or authorised to do so), and use features we offer. You must:</p>
  <ul>
    <li>Provide accurate information when submitting a startup or creating an account.</li>
  ...
  <p>When you submit a startup or other content, you grant us a licence to display and use it to operate the directory. You are responsible for ensuring you have the right to submit that content. We may remove or reject content that violates our guidelines or these terms.</p>
  ...
  <h2>6. Disclaimer</h2>
  <p>The site and listings are provided “as is”. We do not guarantee the accuracy of startup information or that the site will be error-free or always available.</p>
