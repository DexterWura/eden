<section class="dash-card" aria-labelledby="founder-activity-title">
  <div class="dash-card-header">
    <div>
      ...
      <p class="dash-card-subtitle">Upvotes, comments, revenue, and launches across your apps.</p>
    </div>
  </div>
  <?php if ($activity->isEmpty()): ?>
    <div class="dash-placeholder">
      ...
      Activity will appear here as your apps gain momentum.
    </div>
  <?php else: ?>
      ...
      <li class="founder-activity-item founder-activity-item--<?= e($event['type']) ?>">
        ...
        <div class="founder-activity-copy">
          ...
          <?php elseif ($event['type'] === 'upvote'): ?>
            <p><?= e($event['actor'] ?: 'A community member') ?> supported your app.</p>
          ...
          <?php else: ?>
            <p>Your launch date is now part of your app timeline.</p>
          <?php endif; ?>
        </div>
