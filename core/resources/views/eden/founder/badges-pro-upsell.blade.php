...
<div class="dash-card" style="max-width: 480px; margin-top: 24px;">
  <div class="dash-card-body" style="text-align: center; padding: 48px 32px;">
    <div style="font-size: 3rem; color: #f59e0b; margin-bottom: 16px;"><i class="fa-solid fa-certificate"></i></div>
    <h2 style="margin: 0 0 12px; font-size: 1.25rem;">Pro feature</h2>
