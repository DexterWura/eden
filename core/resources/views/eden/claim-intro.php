...
<section class="page-head">
  <div class="wrap">
    ...
    <h1>Claim this app</h1>
    <p>You are about to claim <strong><?= e($startup->name) ?></strong> as your own. Only proceed if you own or represent this app or product.</p>
  </div>
</section>
<div class="wrap content-block form-max">
  <p class="claim-prompt">Do you truly own this app or product?</p>
