  ...
  <div style="max-width:620px;margin:0 auto;padding:32px 18px;">
    <div style="background:#ffffff;border:1px solid #dfe7e4;border-radius:14px;overflow:hidden;">
      ...
      <div style="padding:28px;">
        ...
        <p style="margin:0 0 18px;line-height:1.65;">Your app has been approved and visitors can now discover it on <?= e($siteName) ?>.</p>
        ...
        <div style="margin:22px 0;padding:18px;border-radius:10px;background:#eef8f5;">
          ...
          <span style="line-height:1.55;">Visitors and search engines can follow the website link from your app profile.</span>
          <?php else: ?>
